...
/*   Updated: 2024/07/18 15:17:29 by abkhairi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void Bureaucrat::signForm(AForm *f)
{
    ...
    {
        std::cout << "name =========> " << f->get_name_form() << std::endl;
        std::cout << this->getName() <<" signed " << f->get_name_form() << std::endl;
    }
    else
        std::cout << this->getName() <<" couldn t sign " << f->get_name_form() << " because grade wasn't high enough\n";
}
...
void Bureaucrat::executeForm(AForm const & form){
	...
	{
		form.execute(*this);
        std::cout << this->getName() << " executed " << form.get_name_form();
	}
